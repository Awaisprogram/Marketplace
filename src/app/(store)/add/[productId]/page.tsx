...
import { FaStar, FaHeart, FaShoppingCart, FaShippingFast, FaShieldAlt, FaUndo, FaTruck, FaCheckCircle } from 'react-icons/fa';
...
const ProductDetails = () => {
  ...
  // Mock additional images (you can fetch these from Sanity)
         ...
         <div className="lg:w-4/5 mx-auto flex flex-wrap">
           ...
           <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
               ...
               <div className="flex items-center">
                 ...
                 {colors.map((color, idx) => (
                   <button
                     ...
                     className={`border-2 ${
                       selectedColor === idx ? 'border-blue-500 ring-4 ring-blue-100' : 'border-gray-300'
                     } ${color.class} rounded-full w-10 h-10 focus:outline-none ml-2 transition-all duration-200 hover:scale-110`}
                     title={color.name}
                   />
                 ))}
             ...
             <div className="flex items-center gap-4 mt-6 mb-6">
               ...
               <div className="flex items-center border-2 border-gray-300 rounded-lg">
                 <button 
                   ...
                   className="px-4 py-2 font-bold text-gray-700 hover:bg-gray-100 transition-colors"
                 >
                   -
                 </button>
             ...
             <div className="flex items-center gap-3">
               ...
               <button className="rounded-lg w-14 h-14 bg-gray-100 border-2 border-gray-300 p-0 inline-flex items-center justify-center text-gray-600 hover:bg-red-50 hover:text-red-600 hover:border-red-300 transition-all duration-200">
