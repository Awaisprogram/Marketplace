...
function Location() {
  return (
    <>
      ...
      <div className="flex justify-between flex-col lg:flex-row gap-0 max-w-[1050px] mx-auto px-5 py-24">
        <div className="w-full lg:w-1/3 px-4 py-20 bg-white text-center">
          <FaMapMarkerAlt className="block mx-auto mb-4 text-Color" size={60} />
        ...
        <div className="w-full lg:w-1/3 px-4 py-20 bg-black1 text-center text-white">
          <FaPhoneAlt className="block mx-auto mb-4 text-Color" size={60} />
        ...
        {/* Third Card - Email */}
        <div className="w-full lg:w-1/3 px-4 py-20 bg-white text-center">
          <FaEnvelope className="block mx-auto mb-4 text-Color" size={60} />
      ...
      <div className="p-10 flex flex-col items-center justify-center space-y-2">
        <SlActionRedo size={44} className="text-Color mb-10" />
